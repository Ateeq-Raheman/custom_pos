                ...
                if (response && response.message) {
                    ...
                    frappe.db.get_list("Sales Invoice", {
                        ...
                        let filtered_invoices = response.message.filter(invoice => {
                            console.log(`🔎 Checking Invoice: ${invoice[0]}`);
                            return !returned_invoice_names.includes(invoice[0]);
                        });
                    ...
                    if (original_callback) original_callback(response);
                }
            };
        }
